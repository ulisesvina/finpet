...
const Header = ({ session }: { session: string | null }) => {
    ...
    return (
        <div
            className={
                "visible opacity-100 mb-32 transition-opacity duration-500 ease-in-out"
            }
        >
            <header
                id="header"
                className={`fixed top-0 left-0 w-full flex items-center z-50 transition-transform duration-500 ease-in-out transform translate-y-0`}
            >
